...
public class DenounceDataModel extends LazyDataModel<Denounce> {
	...
	public DenounceDataModel(List<FilterExample> filters, DenounceService service) {
	...
	@Override
	public Object getRowKey(Denounce entity) {
		return entity.getId();
	}
	
	@Override
	public Denounce getRowData(String key) {
		try {
	...
	@Override	
	 public List<Denounce> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
