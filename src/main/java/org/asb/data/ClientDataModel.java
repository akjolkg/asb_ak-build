...
public class ClientDataModel extends LazyDataModel<Client> {
	...
	public ClientDataModel(List<FilterExample> filters, ClientService service) {
	...
	@Override
	public Object getRowKey(Client entity) {
		return entity.getId();
	}
	 ...
	 public List<Client> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
			...
			return this.filters == null || this.filters.isEmpty() 
					...
					: service.findByExample(first, pageSize, sortEnum, this.filters, sortField,new String[]{"appartment"}); 
		} catch(Exception e){
