...
public class ConstructionDataModel extends LazyDataModel<Construction> {
	...
	public ConstructionDataModel(List<FilterExample> filters, ConstructionService service) {
	...
	@Override
	public Object getRowKey(Construction entity) {
		return entity.getId();
	}
	
	@Override
	public Construction getRowData(String key) {
		try {
	...
	@Override	
	 public List<Construction> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
			...
			return this.filters == null || this.filters.isEmpty() 
					...
					: service.findByExample(first, pageSize, sortEnum, this.filters, sortField, new String[]{"company"}); 
		} catch(Exception e){
