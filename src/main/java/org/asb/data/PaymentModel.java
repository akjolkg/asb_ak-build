...
public class PaymentModel extends LazyDataModel<Payment> {
	...
	@Override
	public Object getRowKey(Payment entity) {
		return entity.getId();
	}
	...
	@Override	
	 public List<Payment> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
			...
			if(sortField!="datePayment" && sortOrder!=null && sortOrder==SortOrder.ASCENDING) sortEnum=SortEnum.ASCENDING; 
			return this.filters == null || this.filters.isEmpty() 
					? service.findEntries(first, pageSize, sortField, sortEnum) 
					: service.findByExample(first, pageSize, sortEnum, this.filters, sortField,new String[]{"client","user"}); 
		} catch(Exception e){
