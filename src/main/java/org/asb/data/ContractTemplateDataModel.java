...
public class ContractTemplateDataModel extends LazyDataModel<ContractTemplate> {
	...
	public ContractTemplateDataModel(List<FilterExample> filters, ContractTemplateService service) {
	...
	@Override
	public Object getRowKey(ContractTemplate entity) {
		return entity.getId();
	}
	
	@Override
	public ContractTemplate getRowData(String key) {
		try {
	...
	@Override	
	 public List<ContractTemplate> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
