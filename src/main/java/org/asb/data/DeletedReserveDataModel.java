...
public class DeletedReserveDataModel extends LazyDataModel<DeletedReserve> {
	...
	public DeletedReserveDataModel(List<FilterExample> filters, DeletedReserveService service) {
	...
	@Override
	public Object getRowKey(DeletedReserve entity) {
		return entity.getId();
	}
	
	@Override
	public DeletedReserve getRowData(String key) {
		try {
	...
	@Override	
	 public List<DeletedReserve> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
