...
public class CommentLogModel extends LazyDataModel<CommentLog> {
	...
	public CommentLogModel(List<FilterExample> filters, CommentLogService service) {
	...
	@Override
	public Object getRowKey(CommentLog entity) {
		return entity.getId();
	}
	
	@Override
	public CommentLog getRowData(String key) {
		try {
	...
	@Override	
	 public List<CommentLog> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
