...
public class GarantDataModel extends LazyDataModel<Garant> {
	...
	public GarantDataModel(List<FilterExample> filters, GarantService service) {
	...
	@Override
	public Object getRowKey(Garant entity) {
		return entity.getId();
	}
	
	@Override
	public Garant getRowData(String key) {
		try {
	...
	@Override	
	 public List<Garant> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
