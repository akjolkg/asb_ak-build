...
public class ResponsiblePersonDataModel extends LazyDataModel<ResponsiblePerson> {
	private static final long serialVersionUID = 6199867869667708646L;
	private List<FilterExample> filters = new ArrayList<>();
	private int rowCount;
	private int totalCount;
	private ResponsiblePersonService service;

	public ResponsiblePersonDataModel(List<FilterExample> filters, ResponsiblePersonService service) {
	...
	@Override
	public Object getRowKey(ResponsiblePerson entity) {
		return entity.getId();
	}
	
	@Override
	public ResponsiblePerson getRowData(String key) {
		try {
	...
	@Override	
	 public List<ResponsiblePerson> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		try {
			sortField = sortField == null ? "fio" : sortField;
